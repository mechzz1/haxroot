...
var DEFAULT_PORT = 3300;
var PORT = globals_1.globals.SERVER_PORT || DEFAULT_PORT;
/**
 * Start server
...
function startServer(port) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    logger_1.logger.info("".concat(globals_1.globals.ENV, " Mode"));
                    app = (0, express_1.default)();
                    httpServer = http_1.default.createServer(app);
                    return [4 /*yield*/, (0, index_1.default)(app, httpServer)];
                case 1:
                    server = _a.sent();
                    server.startRouter();
                    server.listen(port);
